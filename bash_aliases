...
alias gitbashrc='cp ~/.bashrc ~/github/dotfiles/bashrc'
alias gitalias='cp ~/.bash_aliases ~/github/dotfiles/bash_aliases'
alias gitfuncs='cp ~/.bash_functions ~/github/dotfiles/bash_functions'
