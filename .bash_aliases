...
alias catalias='if [ -f ~/.bash_aliases ]; then cat ~/.bash_aliases; fi'
alias catfuncs='if [ -f ~/.bash_functions ]; then clear && less ~/.bash_functions; fi'
...
alias getwanip='curl ifconfig.es'
alias getwx='curl wttr.in'
